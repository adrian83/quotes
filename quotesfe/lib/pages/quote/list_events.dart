...
class ListQuoteEventsPage extends ListEventsPage<QuoteEvent> {
  ...
  const ListQuoteEventsPage(Key? key, String title, this._authorId, this._bookId, this._quoteId, this._bookService) : super(key, title);
  ...
  @override
  Future<p.Page<QuoteEvent>> getPage(PageRequest pageReq) => _bookService.listEvents(_authorId, _bookId, _quoteId, pageReq);
}
