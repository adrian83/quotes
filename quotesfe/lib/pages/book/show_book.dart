...
BookEntry _bookToWidget(Book b) =>
    BookEntry(null, b, null, true, true, false, true);
...
class ShowBookPage extends ShowPage<Book> {
  ...
  const ShowBookPage(Key? key, String title, this._authorId, this._bookId,
      this._bookService, this._quoteService)
