...
const String authorUpdatePathPattern =
    r'^/authors/update/([a-zA-Z0-9_.-]*)/?(&[\w-=]+)?$';
const String authorShowPathPattern =
    r'^/authors/show/([a-zA-Z0-9_.-]*)/?(&[\w-=]+)?$';
const String authorDeletePathPattern =
...
String deleteBookPath(Book book) =>
    "/authors/show/${book.authorId}/books/delete/${book.id}";

String updateBookPath(Book book) =>
    "/authors/show/${book.authorId}/books/update/${book.id}";

String listBookEventsPath(Book book) =>
    '/authors/show/${book.authorId}/books/events/${book.id}';

// QUOTES

const String quoteDeletePathPattern =
    r'^/authors/show/([a-zA-Z0-9_.-]*)/books/show/([a-zA-Z0-9_.-]*)/quotes/delete/([a-zA-Z0-9_.-]*)/?(&[\w-=]+)?$';
const String quoteEventsPathPattern =
    r'^/authors/show/([a-zA-Z0-9_.-]*)/books/show/([a-zA-Z0-9_.-]*)/quotes/events/([a-zA-Z0-9_.-]*)/?(&[\w-=]+)?$';
const String quoteCreatePathPattern =
    r'^/authors/show/([a-zA-Z0-9_.-]*)/books/show/([a-zA-Z0-9_.-]*)/quotes/new/?(&[\w-=]+)?$';
const String quoteShowPathPattern =
    r'^/authors/show/([a-zA-Z0-9_.-]*)/books/show/([a-zA-Z0-9_.-]*)/quotes/show/([a-zA-Z0-9_.-]*)/?(&[\w-=]+)?$';
...
String deleteQuotePath(Quote quote) =>
    "/authors/show/${quote.authorId}/books/show/${quote.bookId}/quotes/delete/${quote.id}";

String updateQuotePath(Quote quote) =>
    "/authors/show/${quote.authorId}/books/show/${quote.bookId}/quotes/update/${quote.id}";

String listQuoteEventsPath(Quote quote) =>
    "/authors/show/${quote.authorId}/books/show/${quote.bookId}/quotes/events/${quote.id}";
