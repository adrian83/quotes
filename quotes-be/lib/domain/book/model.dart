...
class Book extends Entity {
  ...
  Book.create(this._title, this._description, this._authorId) : super(Uuid().v4(), DateTime.now().toUtc(), DateTime.now().toUtc());

  Book.update(String id, this._title, this._description, this._authorId) : super(id, DateTime.now().toUtc(), DateTime.now().toUtc());
