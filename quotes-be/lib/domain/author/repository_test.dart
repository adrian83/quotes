...
void main() {
  ...
  test("save should persist author entity", () async {
    when(postgreSQLConnectionMock.execute(insertAuthorStmt, substitutionValues: insertAuthorParams))
  ...
  test("find should return author entity", () async {
    when(postgreSQLConnectionMock.query(getAuthorStmt, substitutionValues: {"id": authorId}))
  ...
  test("update should update and return author entity", () async {
    when(postgreSQLConnectionMock.execute(updateAuthorStmt, substitutionValues: updateAuthorParams))
        .thenAnswer((_) => Future.value());
  ...
  test("delete should delete author entity", () async {
    when(postgreSQLConnectionMock.execute(deleteAuthorStmt, substitutionValues: {"id": authorId}))
        .thenAnswer((_) => Future.value());
  ...
  test("findAuthors should return authors page", () async {
    ...
    when(postgreSQLConnectionMock.query(findAuthorsCountStmt(searchPhrase), substitutionValues: {}))
        .thenAnswer((_) => Future.value([
              [authorsCount]
            ]));
