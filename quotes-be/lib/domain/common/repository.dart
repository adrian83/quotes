...
class Repository<T> {
  ...
  Future<void> updateAtLeastOne(
          String updateStmt, Map<String, Object> params) =>
  ...
  Future<void> deleteAtLeastOne(
          String deleteStmt, Map<String, Object> params) =>
      deleteAll(deleteStmt, params).then((count) {
        if (count == 0) throw FindFailedException();
      });

  Future<int> count(String countStmt, Map<String, Object> params) => connection
      .query(countStmt, substitutionValues: params)
      .then((l) => l[0][0]);

  List<T> toEntities(List<List<dynamic>> entitiesData) => entitiesData
