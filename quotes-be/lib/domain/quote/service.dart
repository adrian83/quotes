...
class QuoteService {
  ...
  Future<Quote> save(Quote quote) =>
      _quotesRepository.save(quote.generateId()).then((quote) => _quoteEventRepository.save(quote));

  Future<Quote> find(String quoteId) => _quotesRepository.find(quoteId);

  Future<Quote> update(Quote quote) =>
      _quotesRepository.update(quote).then((quote) => _quoteEventRepository.update(quote));
