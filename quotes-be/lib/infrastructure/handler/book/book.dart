...
class BookHandler {
  ...
  void persist(HttpRequest req, Params params) =>
      parseForm(req, NewBookFormParser())
          .then((form) =>
              Tuple2(form, PathParam1(params, notEmptyString, requiredAuthorId)))
 ...
 void delete(HttpRequest req, Params params) =>
      Future.value(PathParam2(params, notEmptyString, requiredAuthorId, notEmptyString, requiredBookId))
  ...
  Book createBook(Tuple2<String, String> params, NewBookForm form) => 
  Book.update(params.e2, form.title, form.description, params.e1);

  Book formToBook(Tuple1<String> authorIdBox, NewBookForm form) => 
  Book.create(form.title, form.description, authorIdBox.e1);
