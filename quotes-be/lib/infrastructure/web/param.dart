...
class PathParam2<T1, T2> extends PathParam1<T1> {
  ...
  PathParam2(Params params, Transformer<T1> transformer1, ParamData paramData1, 
  this._transformer2, this._paramData2) : super(params, transformer1, paramData1);
...
class PathParam3<T1, T2, T3> extends PathParam2<T1, T2> {
  ...
  PathParam3(Params params, Transformer<T1> transformer1, ParamData paramData1, Transformer<T2> transformer2, ParamData paramData2,
  this._transformer3, this._paramData3) : super(params, transformer1, paramData1, transformer2, paramData2);
...
class PathParam4<T1, T2, T3, T4> extends PathParam3<T1, T2, T3> {
  ...
  Transformer<T3> transformer3, ParamData paramData3, this._transformer4, this._paramData4) : super(params, transformer1, paramData1, transformer2, paramData2, transformer3, paramData3);
...
class PathParam5<T1, T2, T3, T4, T5> extends PathParam4<T1, T2, T3, T4> {
  ...
  Transformer<T3> transformer3, ParamData paramData3, Transformer<T4> transformer4, ParamData paramData4, this._transformer5, 
  this._paramData5) : super(params, transformer1, paramData1, transformer2, paramData2, transformer3, paramData3, transformer4, paramData4);
