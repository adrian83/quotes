...
var author1 = Author.create("William Shakespeare", author1Desc);
...
var author2 = Author.create("Johann Wolfgang von Goethe", author2Desc);
...
var author3 = Author.create("Adam Bernard Mickiewicz", author3Desc);
...
Future<void> populate(String configPath) async {
  ...
  for (var author in [author1, author2, author3]) {
    await services.authorService.save(author);
  }

  for (var book in [book1, book2, book3, book4]) {
    await services.bookService.save(book);
  }

  for (var quote in [quote1, quote2, quote3, quote4]) {
    await await services.quoteService.save(quote);
  }
