...
class BookEvent extends Book {
  ...
  BookEvent(this._eventId, this._operation, String id, String title, String description, String authorId, DateTime modifiedUtc, DateTime createdUtc)
      : super(id, title, description, authorId, modifiedUtc, createdUtc);

  factory BookEvent.fromJson(Map<String, dynamic> json) => BookEvent(json["eventId"], json["operation"], json["id"], json["title"], json["description"],
      json["authorId"], DateTime.parse(json["modifiedUtc"]), DateTime.parse(json["createdUtc"]));
