...
class QuotesRouter {
  ...
  void showAuthorEvents(authorId) => _router.navigate(authorEventsUrl(authorId));

  // -----

  void createBook(authorId) => _router.navigate(createBookUrl(authorId));

  void showBook(String authorId, String bookId) => _router.navigate(showBookUrl(authorId, bookId));

  void editBook(String authorId, String bookId) => _router.navigate(editBookUrl(authorId, bookId));

  void showBookEvents(String authorId, String bookId) => _router.navigate(bookEventsUrl(authorId, bookId));
  ...
  String showAuthorUrl(String authorId) => RoutePaths.showAuthor.toUrl(parameters: _mapFromParams1(authorId));

  String editAuthorUrl(String authorId) => RoutePaths.editAuthor.toUrl(parameters: _mapFromParams1(authorId));

  String createAuthorUrl() => RoutePaths.newAuthor.toUrl();

  String authorEventsUrl(String authorId) => RoutePaths.authorEvents.toUrl(parameters: _mapFromParams1(authorId));
