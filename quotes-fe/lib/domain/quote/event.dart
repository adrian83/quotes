...
class QuoteEvent extends Quote {
  ...
  QuoteEvent(this._eventId, this._operation, String id, String text,
      String authorId, String bookId, DateTime modifiedUtc, DateTime createdUtc)
      : super(id, text, authorId, bookId, modifiedUtc, createdUtc);

  factory QuoteEvent.fromJson(Map<String, dynamic> json) => QuoteEvent(
      json["eventId"],
      json["operation"],
      json["id"],
      json["text"],
